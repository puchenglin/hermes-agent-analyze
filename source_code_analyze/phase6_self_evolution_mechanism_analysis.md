...
| --- | --- | --- | --- |
| `run_agent.py` | 主会话循环、后台 memory/skill review、写入来源绑定 | `3582`、`3792`、`11017`、`11142`、`14677` | [run_agent.py](../run_agent.py) |
| `agent/curator.py` | Curator 调度、自动状态迁移、LLM 整理 pass、报告写入 | `1`、`198`、`255`、`1278`、`1515`、`1656` | [curator.py](../agent/curator.py) |
| `tools/skill_usage.py` | skill telemetry、agent-created provenance、archive/restore、report | `1`、`216`、`377`、`405`、`479`、`592` | [skill_usage.py](../tools/skill_usage.py) |
| `tools/skill_manager_tool.py` | `skill_manage` 写技能、patch 技能、delete/consolidate 技能 | `557`、`713`、`765`、`800`、`915` | [skill_manager_tool.py](../tools/skill_manager_tool.py) |
| `tools/skill_provenance.py` | 区分 foreground skill 写入与 background-review 自主写入 | `1`、`37`、`75` | [skill_provenance.py](../tools/skill_provenance.py) |
| `tools/skills_tool.py` | `skill_view` 后 bump view/use telemetry | `1500` | [skills_tool.py](../tools/skills_tool.py) |
| `agent/skill_commands.py` | slash skill / preloaded skill bump use telemetry | `432`、`479` | [skill_commands.py](../agent/skill_commands.py) |
| `hermes_cli/curator.py` | `hermes curator` 命令控制面 | `39`、`471` | [curator.py](../hermes_cli/curator.py) |
| `hermes_cli/config.py` | Curator 默认配置与迁移 | `1088` | [config.py](../hermes_cli/config.py) |
| `cli.py` | CLI 启动时触发 Curator | `10473` | [cli.py](../cli.py) |
| `gateway/run.py` | Gateway ticker 中触发 Curator | `15339` | [run.py](../gateway/run.py) |
...
源码位置：[run_agent.py:3582](../run_agent.py#L3582)
...
源码位置：[run_agent.py:11142](../run_agent.py#L11142)
...
源码位置：[run_agent.py:11422](../run_agent.py#L11422) 与 [run_agent.py:14660](../run_agent.py#L14660)
...
源码位置：[run_agent.py:14675](../run_agent.py#L14675) 与 [run_agent.py:3792](../run_agent.py#L3792)
...
源码位置：[run_agent.py:3845](../run_agent.py#L3845)
...
源码位置：[run_agent.py:3729](../run_agent.py#L3729)
...
源码位置：[run_agent.py:11017](../run_agent.py#L11017) 与 [tools/skill_provenance.py:1](../tools/skill_provenance.py#L1)
...
源码位置：[tools/skill_manager_tool.py:713](../tools/skill_manager_tool.py#L713)
...
源码位置：[tools/skill_manager_tool.py:557](../tools/skill_manager_tool.py#L557)
...
源码位置：[tools/skill_usage.py:1](../tools/skill_usage.py#L1)
...
源码位置：[tools/skill_usage.py:216](../tools/skill_usage.py#L216)
...
源码位置：[tools/skill_usage.py:405](../tools/skill_usage.py#L405)
...
源码位置：[agent/curator.py:1](../agent/curator.py#L1)
...
源码位置：[agent/curator.py:198](../agent/curator.py#L198)
...
源码位置：[agent/curator.py:255](../agent/curator.py#L255)
...
源码位置：[tools/skill_usage.py:479](../tools/skill_usage.py#L479)
...
源码位置：[agent/curator.py:1278](../agent/curator.py#L1278)
...
源码位置：[agent/curator.py:1515](../agent/curator.py#L1515)
...
源码位置：[agent/curator.py:329](../agent/curator.py#L329)
...
源码位置：[agent/curator.py:1401](../agent/curator.py#L1401)
...
源码位置：[hermes_cli/curator.py:1](../hermes_cli/curator.py#L1)
...
源码位置：[hermes_cli/config.py:1088](../hermes_cli/config.py#L1088)
